...
public class News extends AppCompatActivity {
    ...
    private static final int PAGE_ACHIEVEMENT = 0;
    private static final int PAGE_EXTRA = 1;
    private static final int PAGE_ACADEMIC = 2;
    private static final int PAGE_EVENT = 3;
...
//            textView.setText(getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER)));
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        FragmentExtra fragmentExtra = new FragmentExtra();
        FragmentAcademic fragmentAcademic = new FragmentAcademic();
