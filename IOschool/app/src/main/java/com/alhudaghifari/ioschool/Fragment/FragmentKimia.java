...
public class FragmentKimia extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.w("FragmentKimia", " onCreateView");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Log.w("FragmentKimia", " onViewCreated");
    }

    @Override
    public void onStart() {
        super.onStart();
        Log.w("FragmentKimia", " onStart");
    }

    @Override
    public void onResume() {
        super.onResume();
        Log.w("FragmentKimia", " onResume");
    }

    @Override
    public void onPause() {
        super.onPause();
        Log.w("FragmentKimia", " onPause");
    }

    @Override
    public void onStop() {
        super.onStop();
        Log.w("FragmentKimia", " onStop");
    }

    @Override
    public void onDestroyView() {
        super.onDestroyView();
        Log.w("FragmentKimia", " onDestroyView");
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        Log.w("FragmentKimia", " onDestroy");
    }
        ...
        mOnArtikelClickListener = new RecyclerFisika.OnArtikelClickListener() {
            ...
            public void onClick(int posisi) {
                try {
                    ...
                    Intent intentdetil = new Intent(FragmentKimia.this.getActivity(), DetilArtikel.class);

                    Log.d("KLIK Posisi : ", posisi + "");

                    switch (posisi) {
                        case 0:
                            intentdetil = new Intent(FragmentKimia.this.getActivity(), DetilArtikel.class);
                            ...
                            FragmentKimia.this.startActivity(intentdetil);
                            break;
    ...
    public void inisialisasiTampilan() {
        final LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(FragmentKimia.this.getActivity());
        mRecyclerView.setLayoutManager(mLinearLayoutManager);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerLibrary = new RecyclerFisika(FragmentKimia.this.getActivity());
