...
public class RecyclerRaportDetil extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private RecyclerRaportDetil.OnArtikelClickListener mOnArtikelClickListener;

    public RecyclerRaportDetil(Context context) {
        mContext = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            default :
                ...
                return new RecyclerRaportDetil.ViewHolderArticle(view);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        RecyclerRaportDetil.ViewHolderArticle viewHolderArticle1 = (RecyclerRaportDetil.ViewHolderArticle) holder;
    ...
    public void setOnArtikelClickListener(RecyclerRaportDetil.OnArtikelClickListener onArtikelClickListener) {
