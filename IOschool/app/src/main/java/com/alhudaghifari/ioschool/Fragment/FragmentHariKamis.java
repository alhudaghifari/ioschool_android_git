...
public class FragmentHariKamis extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.w("FragmentHariKamis", " onCreateView");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Log.w("FragmentHariKamis", " onViewCreated");
    }

    @Override
    public void onStart() {
        super.onStart();
        Log.w("FragmentHariKamis", " onStart");
    }

    @Override
    public void onResume() {
        super.onResume();
        Log.w("FragmentHariKamis", " onResume");
    }

    @Override
    public void onPause() {
        super.onPause();
        Log.w("FragmentHariKamis", " onPause");
    }

    @Override
    public void onStop() {
        super.onStop();
        Log.w("FragmentHariKamis", " onStop");
    }

    @Override
    public void onDestroyView() {
        super.onDestroyView();
        Log.w("FragmentHariKamis", " onDestroyView");
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        Log.w("FragmentHariKamis", " onDestroy");
    }
    ...
    public void inisialisasiTampilan() {
        final LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(FragmentHariKamis.this.getActivity());
        mRecyclerView.setLayoutManager(mLinearLayoutManager);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerLibrary = new RecyclerHari(FragmentHariKamis.this.getActivity());
