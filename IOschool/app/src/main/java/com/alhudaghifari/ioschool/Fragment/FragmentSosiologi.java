...
public class FragmentSosiologi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.w("FragmentSosiologi", " onCreateView");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Log.w("FragmentSosiologi", " onViewCreated");
    }

    @Override
    public void onStart() {
        super.onStart();
        Log.w("FragmentSosiologi", " onStart");
    }

    @Override
    public void onResume() {
        super.onResume();
        Log.w("FragmentSosiologi", " onResume");
    }

    @Override
    public void onPause() {
        super.onPause();
        Log.w("FragmentSosiologi", " onPause");
    }

    @Override
    public void onStop() {
        super.onStop();
        Log.w("FragmentSosiologi", " onStop");
    }

    @Override
    public void onDestroyView() {
        super.onDestroyView();
        Log.w("FragmentSosiologi", " onDestroyView");
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        Log.w("FragmentSosiologi", " onDestroy");
    }
        ...
        mOnArtikelClickListener = new RecyclerFisika.OnArtikelClickListener() {
            ...
            public void onClick(int posisi) {
                try {
                    ...
                    Intent intentdetil = new Intent(FragmentSosiologi.this.getActivity(), DetilArtikel.class);

                    Log.d("KLIK Posisi : ", posisi + "");

                    switch (posisi) {
                        case 0:
                            intentdetil = new Intent(FragmentSosiologi.this.getActivity(), DetilArtikel.class);
                            ...
                            FragmentSosiologi.this.startActivity(intentdetil);
                            break;
    ...
    public void inisialisasiTampilan() {
        final LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(FragmentSosiologi.this.getActivity());
        mRecyclerView.setLayoutManager(mLinearLayoutManager);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerLibrary = new RecyclerFisika(FragmentSosiologi.this.getActivity());
