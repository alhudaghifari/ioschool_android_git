...
public class FragmentMatematika extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.w("FragmentMatematika", " onCreateView");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Log.w("FragmentMatematika", " onViewCreated");
    }

    @Override
    public void onStart() {
        super.onStart();
        Log.w("FragmentMatematika", " onStart");
    }

    @Override
    public void onResume() {
        super.onResume();
        Log.w("FragmentMatematika", " onResume");
    }

    @Override
    public void onPause() {
        super.onPause();
        Log.w("FragmentMatematika", " onPause");
    }

    @Override
    public void onStop() {
        super.onStop();
        Log.w("FragmentMatematika", " onStop");
    }

    @Override
    public void onDestroyView() {
        super.onDestroyView();
        Log.w("FragmentMatematika", " onDestroyView");
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        Log.w("FragmentMatematika", " onDestroy");
    }
        ...
        mOnArtikelClickListener = new RecyclerFisika.OnArtikelClickListener() {
            ...
            public void onClick(int posisi) {
                try {
                    ...
                    Intent intentdetil = new Intent(FragmentMatematika.this.getActivity(), DetilArtikel.class);

                    Log.d("KLIK Posisi : ", posisi + "");

                    switch (posisi) {
                        case 0:
                            intentdetil = new Intent(FragmentMatematika.this.getActivity(), DetilArtikel.class);
                            ...
                            FragmentMatematika.this.startActivity(intentdetil);
                            break;
    ...
    public void inisialisasiTampilan() {
        final LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(FragmentMatematika.this.getActivity());
        mRecyclerView.setLayoutManager(mLinearLayoutManager);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerLibrary = new RecyclerFisika(FragmentMatematika.this.getActivity());
