...
public class FragmentBiologi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.w("FragmentBiologi", " onCreateView");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Log.w("FragmentBiologi", " onViewCreated");
    }

    @Override
    public void onStart() {
        super.onStart();
        Log.w("FragmentBiologi", " onStart");
    }

    @Override
    public void onResume() {
        super.onResume();
        Log.w("FragmentBiologi", " onResume");
    }

    @Override
    public void onPause() {
        super.onPause();
        Log.w("FragmentBiologi", " onPause");
    }

    @Override
    public void onStop() {
        super.onStop();
        Log.w("FragmentBiologi", " onStop");
    }

    @Override
    public void onDestroyView() {
        super.onDestroyView();
        Log.w("FragmentBiologi", " onDestroyView");
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        Log.w("FragmentBiologi", " onDestroy");
    }
        ...
        mOnArtikelClickListener = new RecyclerFisika.OnArtikelClickListener() {
            ...
            public void onClick(int posisi) {
                try {
                    ...
                    Intent intentdetil = new Intent(FragmentBiologi.this.getActivity(), DetilArtikel.class);

                    Log.d("KLIK Posisi : ", posisi + "");

                    switch (posisi) {
                        case 0:
                            intentdetil = new Intent(FragmentBiologi.this.getActivity(), DetilArtikel.class);
                            ...
                            FragmentBiologi.this.startActivity(intentdetil);
                            break;
    ...
    public void inisialisasiTampilan() {
        final LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(FragmentBiologi.this.getActivity());
        mRecyclerView.setLayoutManager(mLinearLayoutManager);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerLibrary = new RecyclerFisika(FragmentBiologi.this.getActivity());
