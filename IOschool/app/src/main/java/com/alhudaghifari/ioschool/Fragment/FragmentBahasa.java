...
public class FragmentBahasa extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.w("FragmentBahasa", " onCreateView");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Log.w("FragmentBahasa", " onViewCreated");
    }

    @Override
    public void onStart() {
        super.onStart();
        Log.w("FragmentBahasa", " onStart");
    }

    @Override
    public void onResume() {
        super.onResume();
        Log.w("FragmentBahasa", " onResume");
    }

    @Override
    public void onPause() {
        super.onPause();
        Log.w("FragmentBahasa", " onPause");
    }

    @Override
    public void onStop() {
        super.onStop();
        Log.w("FragmentBahasa", " onStop");
    }

    @Override
    public void onDestroyView() {
        super.onDestroyView();
        Log.w("FragmentBahasa", " onDestroyView");
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        Log.w("FragmentBahasa", " onDestroy");
    }
        ...
        mOnArtikelClickListener = new RecyclerFisika.OnArtikelClickListener() {
            ...
            public void onClick(int posisi) {
                try {
                    ...
                    Intent intentdetil = new Intent(FragmentBahasa.this.getActivity(), DetilArtikel.class);

                    Log.d("KLIK Posisi : ", posisi + "");

                    switch (posisi) {
                        case 0:
                            intentdetil = new Intent(FragmentBahasa.this.getActivity(), DetilArtikel.class);
                            ...
                            FragmentBahasa.this.startActivity(intentdetil);
                            break;
    ...
    public void inisialisasiTampilan() {
        final LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(FragmentBahasa.this.getActivity());
        mRecyclerView.setLayoutManager(mLinearLayoutManager);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerLibrary = new RecyclerFisika(FragmentBahasa.this.getActivity());
